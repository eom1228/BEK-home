...
const GalleryDesignItem = ({
  ...
  const matchedItem= categories[2].projects.find((project) => String(project.id) === id)
  
  console.log(matchedItem)
  console.log(categories[2].projects.find((project) => String(project.id) === id));
