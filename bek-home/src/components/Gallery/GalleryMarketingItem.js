...
const GalleryMarketingItem = ({
  ...
  const matchedItem= categories[1].projects.find((project) => String(project.id) === id)
  
  console.log(matchedItem)
  console.log(categories[1].projects.find((project) => String(project.id) === id));
