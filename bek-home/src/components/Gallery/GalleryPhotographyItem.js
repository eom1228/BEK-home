...
const GalleryPhotographyItem = ({
  ...
  const matchedItem= categories[3].projects.find((project) => String(project.id) === id)
  
  console.log(matchedItem)
  console.log(categories[3].projects.find((project) => String(project.id) === id));
